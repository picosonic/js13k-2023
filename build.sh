...
for file in "timeline.js" "font.js" "writer.js" "${assetjs}" "${leveljs}" "pathfinder.js" "inputs.js" "signs.js" "main.js"
do
  cat "${file}" >> "${jscat}"
done

# Add the index header
echo -n '<!DOCTYPE html><html><head><meta charset="utf-8"/><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/><title>JS13k 2023</title><style>' > "${indexcat}"
